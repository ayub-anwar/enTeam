...
class LeavesController extends Controller
{
    ...
    public function leaves()
    {
        ...
        $totalLeaves = DB::table('leaves_admins')->join('users','users.user_id','=','leaves_admins.user_id')->count();
        $pendingLeaves = DB::table('leaves_admins')->join('users','users.user_id','=','leaves_admins.user_id')->where('leave_status', 'pending')->count();
        $approvedLeaves = DB::table('leaves_admins')->join('users','users.user_id','=','leaves_admins.user_id')->where('leave_status', 'Approved')->count();
        $declinedLeaves = DB::table('leaves_admins')->join('users','users.user_id','=','leaves_admins.user_id')->where('leave_status', 'Declined')->count();
