...
Route::controller(AttendanceController::class)->group(function () {
    ...
    Route::get('attendanceemployee','attendancecontroller@index');
 });
...
Route::controller(JobController::class)->group(function () {
   ...
   Route::post('page/manage/resumes/{id}', 'deleteResumes')->middleware('auth')->name('page/manage/resumes/id');
    Route::post('delete/Resume','deleteResume')->middleware('auth')->name('delete/Resume');
...
Route::controller(HolidayController::class)->group(function () {
    ...
    Route::post('form/holidays/edit/delete', 'deleteRecord')->middleware('auth')->name('form/holidays/edit/delete');    
});

// ----------------------------- form leaves ------------------------------//   11111111111
...
Route::controller(AttendanceRecordController::class)->group(function(){
    Route::get('attendanceRecord','index')->Middleware('auth')->name('attendanceRecord');
...
Route::controller(TaskController::class)->group(function(){
    ...
    Route::post('deletetask/{id}','deleteRecord')->middleware('auth')->name('delete-task');
    Route::post('updatetask','updateRecord')->middleware('auth')->name('update-task');
